...
export function RealPerformanceMetrics() {
  return (
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 mb-24 relative z-10">
      <div className="flex flex-col md:flex-row items-center gap-12 bg-white rounded-3xl p-8 md:p-12 border border-slate-200 shadow-premium-soft">

        {/* Lewa strona - Opis */}
        <div className="flex-1 space-y-6 text-center md:text-left">
          <div className="flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.2em]">
            <span className="text-emerald-600 font-bold">// CASE STUDY: SKLEP URWIS</span>
            <span className="h-px w-6 bg-emerald-500/30" />
            <span className="text-slate-400 font-medium hidden sm:inline">TELEMETRIA RUM</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-2">
             <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-700 font-mono bg-slate-50 px-4 py-2.5 rounded-xl border border-slate-100">
                <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                <span>Zerowe przesunięcia (0.00 CLS)</span>
             </div>
             <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-700 font-mono bg-slate-50 px-4 py-2.5 rounded-xl border border-slate-100">
                <Smartphone size={16} className="text-slate-400 shrink-0" />
                <span>Rzeczywiści użytkownicy (RUM)</span>
             </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 lg:w-2/5 shrink-0 bg-slate-900 rounded-2xl p-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-y-6 gap-x-4">
            ...
            <MetricItem label="Cumulative Layout Shift" value="0.00" status="good" />
          </div>
...
export default RealPerformanceMetrics;
