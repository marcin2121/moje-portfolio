      ...
      <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-8 md:mb-12 flex flex-col items-start max-w-2xl">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-white leading-[1.1]">
            Kim jestem i dlaczego koduję <span className="text-orange-500">inaczej</span> niż reszta rynku?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-4 order-2 lg:order-1 flex flex-col gap-4">
            <motion.div 
              ...
              className="bg-zinc-900/40 border border-white/5 rounded-3xl p-5 lg:p-6 flex flex-col gap-2 backdrop-blur-sm relative overflow-hidden group hover:border-orange-500/30 transition-colors"
            >
              ...
              <h3 className="text-lg font-bold text-white relative z-10">Next.js & Performance</h3>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-white relative z-10">Twardy Biznes</h3>
              <p className="text-xs text-zinc-400 font-light leading-relaxed relative z-10">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-white relative z-10">Maszyny Sprzedażowe</h3>
              <p className="text-xs text-zinc-400 font-light leading-relaxed relative z-10">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-50px" }}
            className="lg:col-span-8 order-1 lg:order-2 bg-zinc-950/80 border border-white/10 rounded-[2rem] p-6 lg:p-10 relative overflow-hidden"
          >
            {/* Subtelny wzór tła */}
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none bg-[url('https://grainy-gradients.vercel.app/noise.svg')]" />
            
            <div className="flex items-center gap-4 mb-6 relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-zinc-900 border border-white/10 shrink-0 shadow-2xl overflow-hidden relative">
                <Image src="/Marcin.jpg" alt="Marcin Molenda" fill className="object-cover" />
              </div>
              <div>
                <div className="text-xl font-bold text-white tracking-tight">Marcin Molenda</div>
                <div className="text-[11px] text-orange-500 font-medium uppercase tracking-widest">Niezależny Inżynier Oprogramowania</div>
              </div>
            </div>

            <div className="space-y-4 text-sm sm:text-base text-zinc-300 font-light leading-relaxed relative z-10">
              <p>
