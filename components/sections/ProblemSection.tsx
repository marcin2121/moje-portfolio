...
export function ProblemSection() {
  ...
  return (
    <section ref={ref} id="problem" className="w-full lg:w-screen h-auto lg:h-screen lg:min-h-[100dvh] flex-shrink-0 flex items-center justify-center relative overflow-x-hidden bg-transparent py-24 lg:py-0">
